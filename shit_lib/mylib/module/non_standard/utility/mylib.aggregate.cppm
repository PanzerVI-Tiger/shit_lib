...
export namespace mylib {
    ...
    constexpr size_t member_objects_size() noexcept {
        if constexpr (mylib::has_n_member_objects<Type, 0>) {
            return 0;
        } else if constexpr (mylib::has_n_member_objects<Type, 1>) {
            return 1;
        } else if constexpr (mylib::has_n_member_objects<Type, 2>) {
            return 2;
        } else if constexpr (mylib::has_n_member_objects<Type, 3>) {
            return 3;
        } else if constexpr (mylib::has_n_member_objects<Type, 4>) {
            return 4;
        } else if constexpr (mylib::has_n_member_objects<Type, 5>) {
            return 5;
        } else if constexpr (mylib::has_n_member_objects<Type, 6>) {
            return 6;
        } else if constexpr (mylib::has_n_member_objects<Type, 7>) {
            return 7;
        } else if constexpr (mylib::has_n_member_objects<Type, 8>) {
            return 8;
        } else if constexpr (mylib::has_n_member_objects<Type, 9>) {
            return 9;
        } else if constexpr (mylib::has_n_member_objects<Type, 10>) {
            return 10;
        } else if constexpr (mylib::has_n_member_objects<Type, 11>) {
            return 11;
        } else if constexpr (mylib::has_n_member_objects<Type, 12>) {
            return 12;
        } else if constexpr (mylib::has_n_member_objects<Type, 13>) {
            return 13;
        } else if constexpr (mylib::has_n_member_objects<Type, 14>) {
            return 14;
        } else if constexpr (mylib::has_n_member_objects<Type, 15>) {
            return 15;
        } else if constexpr (mylib::has_n_member_objects<Type, 16>) {
            return 16;
        } else {
    ...
    constexpr auto member_objects(const Type& object) noexcept
    {
        if constexpr (mylib::has_n_member_objects<Type, 0>) {
            ...
            mylib::assign(std::get<0>(result), a);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 2>) {
            auto [a, b] = object;
            std::tuple<decltype(a), decltype(b)> result;
            mylib::assign(std::get<0>(result), a);
            mylib::assign(std::get<1>(result), b);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 3>) {
            auto [a, b, c] = object;
            ...
            mylib::assign(std::get<0>(result), a);
            mylib::assign(std::get<1>(result), b);
            mylib::assign(std::get<2>(result), c);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 4>) {
            auto [a, b, c, d] = object;
            ...
            mylib::assign(std::get<1>(result), b);
            mylib::assign(std::get<2>(result), c);
            mylib::assign(std::get<3>(result), d);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 5>) {
            ...
            mylib::assign(std::get<2>(result), c);
            mylib::assign(std::get<3>(result), d);
            mylib::assign(std::get<4>(result), e);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 6>) {
            ...
            mylib::assign(std::get<3>(result), d);
            mylib::assign(std::get<4>(result), e);
            mylib::assign(std::get<5>(result), f);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 7>) {
            ...
            mylib::assign(std::get<4>(result), e);
            mylib::assign(std::get<5>(result), f);
            mylib::assign(std::get<6>(result), g);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 8>) {
            ...
            mylib::assign(std::get<5>(result), f);
            mylib::assign(std::get<6>(result), g);
            mylib::assign(std::get<7>(result), h);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 9>) {
            ...
            mylib::assign(std::get<6>(result), g);
            mylib::assign(std::get<7>(result), h);
            mylib::assign(std::get<8>(result), i);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 10>) {
            ...
            mylib::assign(std::get<7>(result), h);
            mylib::assign(std::get<8>(result), i);
            mylib::assign(std::get<9>(result), j);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 11>) {
            ...
            mylib::assign(std::get<8>(result),  i);
            mylib::assign(std::get<9>(result),  j);
            mylib::assign(std::get<10>(result), k);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 12>) {
            ...
            mylib::assign(std::get<9>(result),  j);
            mylib::assign(std::get<10>(result), k);
            mylib::assign(std::get<11>(result), l);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 13>) {
            ...
            mylib::assign(std::get<10>(result), k);
            mylib::assign(std::get<11>(result), l);
            mylib::assign(std::get<12>(result), m);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 14>) {
            ...
            mylib::assign(std::get<11>(result), l);
            mylib::assign(std::get<12>(result), m);
            mylib::assign(std::get<13>(result), n);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 15>) {
            ...
            mylib::assign(std::get<12>(result), m);
            mylib::assign(std::get<13>(result), n);
            mylib::assign(std::get<14>(result), o);
            return result;
        } else if constexpr (mylib::has_n_member_objects<Type, 16>) {
            ...
            mylib::assign(std::get<13>(result), n);
            mylib::assign(std::get<14>(result), o);
            mylib::assign(std::get<15>(result), p);
            return result;
        } else {
            static_assert(mylib::always_false<Type>, "can't handle so many members!");
        }
    ...
    struct aggregate_traits {
        ...
        static constexpr std::string types_string() noexcept {
            ...
            [&name] <typename... Types> (
                ...
                bool isStart = true;
               (..., (name += (isStart ? isStart = false, ""s : ", "s) + 
                typeid(Types).name()));
            }(member_objects({}));
    ...
    template<size_t count, typename Type>
    using make_n_same_type_tuple_t =
        typename mylib::make_n_same_type_tuple<count, Type>::type;
        ...
        static constexpr auto member_objects_ref(Type (&object)[arraySize]) noexcept {
            return
                [&object]<size_t... indices> (
                    ...
                    return
                        mylib::make_n_same_type_tuple_t<
                            arraySize, Type&
                        >{ object[indices]... };
                }(std::make_index_sequence<arraySize>{});
        }
