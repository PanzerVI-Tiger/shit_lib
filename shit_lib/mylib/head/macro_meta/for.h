...
#define mylib_pp_for_impl(var, pred, callable) \
    mylib_pp_for3(var, pred, callable)
#define mylib_pp_for(var, pred, callable) \
    mylib_pp_for_impl(var, pred, callable)
...
#define mylib_pp_for0(var, pred, callable) \
    mylib_pp_if(pred(var)) () (var)
#define mylib_pp_for1(var, pred, callable)                                      \
    mylib_pp_if(pred(var)) (mylib_pp_for0(callable(var), pred, callable)) (var)
#define mylib_pp_for2(var, pred, callable)                                      \
    mylib_pp_if(pred(var)) (mylib_pp_for1(callable(var), pred, callable)) (var)
#define mylib_pp_for3(var, pred, callable)                                      \
    mylib_pp_if(pred(var)) (mylib_pp_for2(callable(var), pred, callable)) (var)
