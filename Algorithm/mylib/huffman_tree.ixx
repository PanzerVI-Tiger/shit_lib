...
export namespace mylib {
	...
	template<
		...
		typename _RootNodeType = pair_binary_tree_root_node<_WeightType, _MappedType, _Compare, _Allocator>
	>
	struct list_huffman_tree : public base_pair_binary_tree<_WeightType, _MappedType, _Compare, _Allocator> {
	public:
		using base_type = base_pair_binary_tree<_WeightType, _MappedType, _Compare, _Allocator>;
		
		using key_type = std::remove_reference_t<_WeightType>;
		...
		list_huffman_tree(std::set<node_pointer>& _NodeSet) {		
